  ...
  Future<CupertinoLocalizations> load(Locale locale) {
    ...
    return SynchronousFuture<CupertinoLocalizations>(
      CkbCupertinoLocalizations(
        ...
        shortDateFormat: intl.DateFormat('MM/DD/YY', "ar"),
        compactDateFormat: intl.DateFormat('EEE, MMM d', "ar"),
        shortMonthDayFormat: intl.DateFormat('MM/DD', "ar"),
        mediumDateFormat: intl.DateFormat('EEE, MMM d', "ar"),
        longDateFormat: intl.DateFormat('EEEE, MMMM d, y', "ar"),
...
class CkbCupertinoLocalizations extends GlobalCupertinoLocalizations {
   CkbCupertinoLocalizations({
    ...
    required intl.NumberFormat twoDigitZeroPaddedFormat,
          ...
          localeName: "ckb",
          doubleDigitMinuteFormat: intl.DateFormat("#", "ar"),
          dayFormat: intl.DateFormat("#","ar"),
          singleDigitHourFormat: intl.DateFormat("#","ar"),
          singleDigitMinuteFormat: intl.DateFormat("#","ar"),
          singleDigitSecondFormat: intl.DateFormat("#","ar"),
